...
```json
{
  ...
  "source": {
    "launcher": {
      ...
      "provenance_ref": "https://us-central1-docker.pkg.dev/project/repo/launcher@sha256:abc123...",
      "signature": {
    ...
    "builder": {
      ...
      "provenance_ref": "https://us-central1-docker.pkg.dev/project/repo/builder@sha256:def456...",
      "signature": {
        "keyid": "google-cloud-build",
        "sig": "base64-encoded-signature..."
      }
