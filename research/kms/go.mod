module github.com/google/go-tpm-tools/research/kms

go 1.24.4

replace github.com/google/go-tpm-tools => ../..

replace github.com/google/go-tpm-tools/rpverifier => ../../rpverifier

replace github.com/Layr-Labs/eigenx-contracts => /Users/cavan/source/eigenx-contracts

require (
	cloud.google.com/go/storage v1.50.0
	github.com/Layr-Labs/eigenx-contracts v0.0.0
	github.com/ethereum/go-ethereum v1.16.7
	github.com/google/gce-tcb-verifier v0.3.1
	github.com/google/go-tpm-tools/rpverifier v0.0.0-00010101000000-000000000000
